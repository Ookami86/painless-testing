/*
  ...
  Authors: Luke Mahé (code)
           ...
           With adaptations by Johannes Seitz (Footer, Language Switching)

  URL: https://scm.printhelloworld.de/repos/hg/html5slides
...
$(document).ready(function(){
    if (document.allLangs){
        var lang = params["lang"];
        if (!lang){
            var lang = document.allLangs[0];
        }
        for(i=0; i < document.allLangs.length; i++){
            if(lang!==document.allLangs[i]) {
                $("." + document.allLangs[i]).css("display", "none");
            };
        }
    }
});
